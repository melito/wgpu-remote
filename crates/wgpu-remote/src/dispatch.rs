...
impl<C: Connection + Clone + 'static> std::fmt::Debug for Instance<C> {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        f.debug_struct("wgpu_remote::Instance").finish_non_exhaustive()
    }
}
...
impl<C: Connection + Clone + 'static> std::fmt::Debug for Adapter<C> {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        f.debug_struct("wgpu_remote::Adapter").finish_non_exhaustive()
    }
}
...
macro_rules! resource_adapter {
    (
        ...
        impl<C: Connection + Clone + 'static> std::fmt::Debug for $name<C> {
            fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                f.debug_struct(concat!("wgpu_remote::", stringify!($name)))
...
impl<C: Connection + Clone + 'static> std::fmt::Debug for Buffer<C> {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        f.debug_struct("wgpu_remote::Buffer").finish_non_exhaustive()
    }
}
...
impl std::fmt::Debug for BufferMappedRange {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        f.debug_struct("wgpu_remote::BufferMappedRange")
            .finish_non_exhaustive()
    }
}
...
impl<C: Connection + Clone + 'static> std::fmt::Debug for ShaderModule<C> {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        f.debug_struct("wgpu_remote::ShaderModule").finish_non_exhaustive()
    }
}
...
impl<C: Connection + Clone + 'static> std::fmt::Debug for ComputePipeline<C> {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        f.debug_struct("wgpu_remote::ComputePipeline").finish_non_exhaustive()
    }
}
...
impl<C: Connection + Clone + 'static> std::fmt::Debug for RenderPipeline<C> {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        f.debug_struct("wgpu_remote::RenderPipeline").finish_non_exhaustive()
    }
}
...
impl<C: Connection + Clone + 'static> std::fmt::Debug for Texture<C> {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        f.debug_struct("wgpu_remote::Texture").finish_non_exhaustive()
    }
}
...
impl<C: Connection + Clone + 'static> std::fmt::Debug for Device<C> {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        f.debug_struct("wgpu_remote::Device").finish_non_exhaustive()
    }
}
...
impl<C: Connection + Clone + 'static> std::fmt::Debug for Queue<C> {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        f.debug_struct("wgpu_remote::Queue").finish_non_exhaustive()
    }
}
...
impl<C: Connection + Clone + 'static> QueueInterface for Queue<C> {
    ...
    fn submit(
        ...
        let recordings: Vec<crate::client::CommandBuffer> = command_buffers
            .map(|cb| {
                let recorded = cb
                    .as_custom::<CommandBuffer>()
                    .expect("Queue::submit received a command buffer from a different backend");
                crate::client::CommandBuffer::from_recording(recorded.recording.clone())
            })
            .collect();
...
impl<C: Connection + Clone + 'static> std::fmt::Debug for CommandEncoder<C> {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        f.debug_struct("wgpu_remote::CommandEncoder").finish_non_exhaustive()
    }
}
...
impl<C: Connection + Clone + 'static> std::fmt::Debug for ComputePass<C> {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        f.debug_struct("wgpu_remote::ComputePass").finish_non_exhaustive()
    }
}
...
impl<C: Connection + Clone + 'static> std::fmt::Debug for RenderPass<C> {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        f.debug_struct("wgpu_remote::RenderPass").finish_non_exhaustive()
    }
}
...
impl std::fmt::Debug for CommandBuffer {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        f.debug_struct("wgpu_remote::CommandBuffer").finish_non_exhaustive()
    }
}
